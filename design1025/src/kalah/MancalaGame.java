...
public class MancalaGame {
    ...
    private static void CaptureAction(Player player, Player oppositePlayer, int captureHouse) {
        int totalSeeds;
    ...
    private boolean IsGameEnd(boolean playerStop, boolean myTurn) {
        return playerStop && myTurn;
    }

    private void PlayerPlayGame(Player p1, Player p2, IO io) {
        int houseNumber;
    ...
    void StartGame(IO io) {
        ...
        while (true) {
            ...
            if (p1.GetMyTurn()) {
                if (IsGameEnd(p1.IsStop(), p1.GetMyTurn())) {
                ...
                if (IsGameEnd(p2.IsStop(), p2.GetMyTurn())) {
                    board.PrintBoard("LAST_STEP", p1, p2, io);
                    break;
                }
    ...
    private void CalculateFinalScore(Player p1, Player p2) {
