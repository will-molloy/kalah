...
public class Kalah {
    ...
    public void play(IO io) {
        ...
        String input = io.readFromKeyboard("Player P" + board.getCurrentPlayerNumber() + "'s turn - Specify house number or 'q' to quit: ");
    ...
    private boolean isGameFinished(String input, Board board) {
        return input.equals("q") || board.hasCurrentPlayerLost();
    }
}
